...
namespace EasyEditor
{
    ...
    abstract public class InspectorItemRenderer : ScriptableObject
    {
		...
		public HorizontalLayout horizontalLayout = HorizontalLayout.None;
		public VerticalLayout verticalLayout = VerticalLayout.None;
        ...
        private bool serializedObjectSet = false;
        /// <summary>
        ...
        /// <summary>
        /// Gets the label of the renderer if if it relevant to the renderer.
        /// </summary>
		...
		{
			InspectorAttribute inspectorAttribute = AttributeHelper.GetAttribute<InspectorAttribute> (_entityInfo);
		...
		{
			CommentAttribute commentAttribute = AttributeHelper.GetAttribute<CommentAttribute> (_entityInfo);
        ...
        virtual public void Render(Action preRender = null)
        {
            ...
            {
                Debug.LogWarning("Your InspectorItemRenderer does not have a serialized object set. This could raise errors in the rendering process.");
            }
        }
		...
		static public InspectorItemRenderer GetRendererFromFieldInfo(FieldInfo fieldInfo, string propertyPath = "")
		{
			return GetRendererFromEntityInfo (new EntityInfo (fieldInfo, propertyPath));
		}
		...
		static public InspectorItemRenderer GetRendererFromMethodInfo(MethodInfo methodInfo, object caller)
		{
			return GetRendererFromEntityInfo (new EntityInfo (methodInfo, caller));
		}
