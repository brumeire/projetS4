...
namespace EasyEditor
{
    ...
    abstract public class FullObjecRenderer : InspectorItemRenderer
    {
        ...
        private void InitializeGroups()
        {
            ...
            InitializeGroupHeaderVisibility();
        }
        ...
        private void InitializeGroupHeaderVisibility()
        {
            foreach (InspectorItemRenderer renderer in renderers)
            {
                if(renderer.inspectorAttribute.displayHeader == false)
                {
                    groups.SetGroupDisplayHeader(renderer.inspectorAttribute.group, renderer.inspectorAttribute.displayHeader);
                }
            }
        }
