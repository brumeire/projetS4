...
[ExecuteInEditMode]
[AddComponentMenu("Custom/BlackHole")]
[System.Serializable]
public class BlackHoleCtlr : MonoBehaviour
{
    ...
    private string shader = "Custom/BlackHole";
    [HideInInspector]
    [Range(0, 1)]
    ...
    void Update()
    {
        Distortion = Mathf.Sin(Time.time) * ((maxDist - minDist) / 2) + (maxDist - ((maxDist - minDist) / 2));
...
#if UNITY_EDITOR
[CustomEditor(typeof(BlackHoleCtlr)), CanEditMultipleObjects]
public class BlackHoleCtlr_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        BlackHoleCtlr _2dxScript = (BlackHoleCtlr)target;
