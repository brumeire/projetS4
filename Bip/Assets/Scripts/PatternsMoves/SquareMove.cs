...
public class SquareMove : MonoBehaviour {
    ...
    public PatternSquare movementType;

    public EntityScript.Type type;

    public float size = 1.67f;
	...
	public void StartSquare ()
    {
        ...
        switch (movementType)
        {
            case PatternSquare.RandomToCenter:
                direction = -transform.position;
                direction += (Vector3)Random.insideUnitCircle.normalized * Guru.instance.size * Mathf.Lerp(1.1f, 1.1f, Guru.instance.Ressources / Guru.instance.RessourcesMax);
                break;
        }
